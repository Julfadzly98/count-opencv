...
while cap.isOpened():
    ...
    for contour in contours:
        ...
        if 239<=xPoint<242:
            ...
            if area > 156500:
                counter = counter+2
                form_url = "https://docs.google.com/forms/d/e/1FAIpQLSdIS9RE2M9KV5jCTGSlpM0Jq5aSYFVaghFv9QQ0zPKwRvS20Q/formResponse?usp=pp_url&entry.344195359={}&submit=Submit".format(counter)
